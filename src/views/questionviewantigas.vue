<template>
    <v-container>
      ...
      <ADQUESRIONS @question-added="getQuestions" />
...
import ADQUESRIONS  from '../components/ADQUESTIONS2.vue';
...
export default defineComponent({
  ...
  setup() {
    ...
    const getQuestions = async () => {
      try {
        const response = await api.get('/a/questions'); // Faz a requisição GET
